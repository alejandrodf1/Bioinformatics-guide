# bioinformatics guide guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `bioinformatics_guide/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `bioinformatics_guide` folder and use the modules inside your notebooks :
